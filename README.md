...
Chrome extension that reads the automation rules of an Asana project out of the UI and saves them as JSON, so you can hand them to an AI agent to explain, debug, or propose changes.
...
```json
{
  "project": "Internal Product Feedback",
  "rules": [
    {
      "id": "1200000000000000",
      "name": "Search Rules",
      ...
      "branches": [
        {
          "if": { "all": ["SERP Scam Result is set to Yes", "Surface Area is set to Search Ads"] },
          "do": [
